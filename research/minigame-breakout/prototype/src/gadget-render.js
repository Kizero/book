...
export function drawGadgets(c,g,clock,assets){
 ...
 for(const b of fx.bubbles){
  if(b.command>0){const a=Math.atan2(b.vy,b.vx);c.strokeStyle='#f8da78';c.lineWidth=3;c.beginPath();c.moveTo(b.x-Math.cos(a)*b.r,b.y-Math.sin(a)*b.r);c.lineTo(b.x-Math.cos(a)*50,b.y-Math.sin(a)*50);c.stroke();}
