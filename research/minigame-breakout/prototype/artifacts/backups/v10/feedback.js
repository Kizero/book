import {BOSS_ACT_NAMES} from './boss-choreography.js?v=10';
...
export class Feedback {
 ...
 event(e,g){
  ...
  const names={'parcel-open':['回收包打开 · 补弹！','#fff0b8'],'boss-rest':['喘气了，放开喷！','#ffeab4'],'gust':['风向锁定','#d0f4ff'],'foam-boost':['泡沫裹弹','#d7ffff'],'relay':['拖把接力','#e5f5b5'],'bubble-pop':['爆泡清洁','#c5f3ff'],'bucket-toss':['泥桶要翻啦！','#ffe1a0']};
