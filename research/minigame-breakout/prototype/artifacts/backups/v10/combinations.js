...
export const EVOLUTIONS=[
 {id:'stormduck',name:'雷泡运输队',needs:{bubble:2,duck:2,electric:1},description:'小鸭运送的泡泡带电，爆泡额外电击周围怪物。'},
 {id:'washstorm',name:'电动洗地风暴',needs:{brush:2,electric:2},description:'刷盘持续铺泡沫，让电弧沿清洁轨迹传开。'},
 {id:'pinball',name:'双盘清扫阵',needs:{brush:2,mop:2},description:'每轮掷出两枚刷盘；刷盘遇到拖把也可加速接力。'}
];
